...
salir = 1
"""
Ejecucion del programa hasta que esciban 0
"""
while salir != 0:
    print("***************************************************")
    print("****************Cero (0) - Salir -*****************")
    ...
    Placa = Placa.upper()
    """
    Valida que la longitud de la cadena que el usuario a ingresado no sea mayor a seis posiciones
    """
    if len(Placa) != 6:
        if Placa == '0':
            break
        ...
        """
        Ejecuta la validacion de la placa
        """
        Valida(Placa)
clear()
